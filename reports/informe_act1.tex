...
\vspace{0.6em}
\footnotesize
\textit{Código reproducible:} \texttt{notebooks/act1\_anexo.ipynb} \quad
\textit{Diccionario de datos:} \texttt{docs/data\_dictionary.md} \quad
\textit{Iteraciones CRISP-DM:} \texttt{docs/CHANGELOG\_iteraciones.md} \quad
\textit{Decisiones de ingeniería:} \texttt{docs/adr/} \quad
\textit{Fuentes:} \texttt{docs/fuentes/}
