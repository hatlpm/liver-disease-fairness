...
\textbf{Caveat necesario:} parte de la asimetría es aritmética, ya que la ventana femenina (19--40) es más ancha que la masculina (30--40). Lo que \textbf{no} es aritmético es que \textbf{70 de las 142 mujeres tengan efectivamente su ALT dentro de esa franja}: una ventana ancha solo atrapa gente si hay gente dentro. Ajustando por ese ancho, la densidad femenina en su franja (0.0235/U$\cdot$L) es \textbf{$\sim$40\% mayor} que la masculina en la suya (0.0168/U$\cdot$L): no se explica solo por el ancho.
