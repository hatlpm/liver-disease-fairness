...
**Caveat necesario:** parte de la asimetría es aritmética, ya que la ventana femenina (19–40] es más ancha que la masculina (30–40]. Lo que **no** es aritmético es que **70 de las 142 mujeres tengan efectivamente su ALT dentro de esa franja**, frente a 69 de 441 hombres en la suya: una ventana ancha solo atrapa gente si hay gente dentro. Ajustando por ese ancho, la densidad de mujeres por unidad de ALT en su franja (0.0235/U·L) es **exactamente un 50% mayor** que la de los hombres en la suya (0.0156/U·L) — la concentración femenina no se explica solo por el tamaño de la ventana.
